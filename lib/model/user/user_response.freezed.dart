...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int page, int per_page, List<UserModel> data});
}
...
class _$UserResponseImpl implements _UserResponse {
  ...
  @override
  String toString() {
    return 'UserResponse(page: $page, per_page: $per_page, data: $data)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, page, per_page, const DeepCollectionEquality().hash(_data));
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse(
      ...
      required final List<UserModel> data}) = _$UserResponseImpl;
